...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CommunicationManager_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(21, 16), // "requestCompleted"
QT_MOC_LITERAL(38, 0), // ""
QT_MOC_LITERAL(39, 9), // "BusResult"
QT_MOC_LITERAL(49, 6), // "result"
QT_MOC_LITERAL(56, 20), // "busConnectionChanged"
QT_MOC_LITERAL(77, 5), // "busId"
QT_MOC_LITERAL(83, 9), // "connected"
QT_MOC_LITERAL(93, 7), // "message"
QT_MOC_LITERAL(101, 10) // "logMessage"

    },
    "CommunicationManager\0requestCompleted\0"
    "\0BusResult\0result\0busConnectionChanged\0"
    "busId\0connected\0message\0logMessage"
};
...
void CommunicationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CommunicationManager::*)(const BusResult & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationManager::requestCompleted)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CommunicationManager::*)(const QString & , bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationManager::busConnectionChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CommunicationManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CommunicationManager.offsetsAndSize,
...
// SIGNAL 0
void CommunicationManager::requestCompleted(const BusResult & _t1)
{
...
// SIGNAL 1
void CommunicationManager::busConnectionChanged(const QString & _t1, bool _t2, const QString & _t3)
{
...
// SIGNAL 2
void CommunicationManager::logMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
