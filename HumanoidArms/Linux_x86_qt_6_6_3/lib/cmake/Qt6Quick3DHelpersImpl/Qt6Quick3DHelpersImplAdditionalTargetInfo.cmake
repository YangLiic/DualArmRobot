...
get_target_property(_qt_imported_soname Qt6::Quick3DHelpersImpl IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Quick3DHelpersImpl PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Quick3DHelpersImpl PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
