...
set_target_properties(Qt6::LabsFolderListModel PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6LabsFolderListModel.so.6.6.3"
  IMPORTED_SONAME_RELEASE "libQt6LabsFolderListModel.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LabsFolderListModel )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LabsFolderListModel "${_IMPORT_PREFIX}/lib/libQt6LabsFolderListModel.so.6.6.3" )
