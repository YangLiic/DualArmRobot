...
get_target_property(_qt_imported_soname Qt6::Protobuf IMPORTED_SONAME_RELEASE)
get_target_property(_qt_imported_location_default Qt6::Protobuf IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
get_target_property(_qt_imported_soname_default Qt6::Protobuf IMPORTED_SONAME_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname_default)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_SONAME "${_qt_imported_soname_default}")
endif()
