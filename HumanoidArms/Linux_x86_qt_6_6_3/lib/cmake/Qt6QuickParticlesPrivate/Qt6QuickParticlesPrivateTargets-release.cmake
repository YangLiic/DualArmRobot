...
set_target_properties(Qt6::QuickParticlesPrivate PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6QuickParticles.so.6.6.3"
  IMPORTED_SONAME_RELEASE "libQt6QuickParticles.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::QuickParticlesPrivate )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::QuickParticlesPrivate "${_IMPORT_PREFIX}/lib/libQt6QuickParticles.so.6.6.3" )
