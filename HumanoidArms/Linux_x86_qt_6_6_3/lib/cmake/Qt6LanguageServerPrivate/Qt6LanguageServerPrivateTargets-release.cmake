...
set_target_properties(Qt6::LanguageServerPrivate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6LanguageServer.so.6.6.3"
  IMPORTED_SONAME_RELEASE "libQt6LanguageServer.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LanguageServerPrivate )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LanguageServerPrivate "${_IMPORT_PREFIX}/lib/libQt6LanguageServer.so.6.6.3" )
